...
if (isset($_POST['submit'])) {
    ...
    $cpass = mysqli_real_escape_string($conect, md5($_POST['cpassword']));
    ...
    if (mysqli_num_rows($select_users) > 0) {
        ...
        if ($pass != $cpass) {
            ...
            mysqli_query($conect, "INSERT INTO `users`(name, email, password, user_type) VALUES('$name', '$email', '$cpass', '$user_type')") or die('query failed');
