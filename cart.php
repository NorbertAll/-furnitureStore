...
if (isset($_POST['update_cart'])) {
    ...
    mysqli_query($conect, "UPDATE `cart` SET quantity = '$cart_quantity' WHERE id = '$cart_id'") or die('query failed');
    $message[] = 'cart quantity updated!';
}

if (isset($_GET['delete'])) {
    $delete_id = $_GET['delete'];
    mysqli_query($conect, "DELETE FROM `cart` WHERE id = '$delete_id'") or die('query failed');
